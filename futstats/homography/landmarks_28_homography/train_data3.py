...
def main(train: bool = True, test: bool = False):
    MODEL_ARCH = "yolo_nas_s"
    CHECKPOINT_DIR = "./checkpoints"

    EXPERIMENT = "FIELD_KEYPOINTS_COCO_DATA_3"
    LOCATION = (
        "/home/fer/Escritorio/futstatistics/datasets/field/keypoints3_2/yolo/splits"
    )
    BATCH_SIZE = 32
    # INPUT_DIM = [
    #     320,
